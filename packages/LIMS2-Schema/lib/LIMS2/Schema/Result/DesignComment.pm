use utf8;
package LIMS2::Schema::Result::DesignComment;
...
Related object: L<LIMS2::Schema::Result::DesignCommentCategory>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:pu3wO/VkJfWqRmft/kuAEA
