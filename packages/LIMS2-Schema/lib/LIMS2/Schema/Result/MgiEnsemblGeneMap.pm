use utf8;
package LIMS2::Schema::Result::MgiEnsemblGeneMap;
...
Related object: L<LIMS2::Schema::Result::EnsemblGeneData>

=cut

__PACKAGE__->belongs_to(
  "ensembl_gene",
  "LIMS2::Schema::Result::EnsemblGeneData",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:3R5WtavvsDYUrTPogo7yxg
