use utf8;
package LIMS2::Model::Schema::Result::ProcessPipeline;
...
=head1 TABLE: C<process_pipeline>

=cut

__PACKAGE__->table("process_pipeline");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:q4fWcQwC8fGWGBlRcGuSNA
