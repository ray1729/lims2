use utf8;
package LIMS2::Model::Schema::Result::DesignWellDesign;
...
=head1 TABLE: C<design_well_design>

=cut

__PACKAGE__->table("design_well_design");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:I1N8IcBXxYcvsLhlpR5JCg
